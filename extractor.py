...
##########################################################################################
# Code was taken from https://github.com/ShirAmir/dino-vit-features/blob/main/extractor.py
##########################################################################################
...
class ViTExtractor:
    ...
    def __init__(self, model_type: str = 'dino_vits8', stride: int = 4, model=None, device: str = 'cuda',
                 model_dir: str = None, head: str = "student"):
        """
        ...
        self.device = device
        if model:
            self.model = ViTExtractor.create_model(model_type, model_dir, head, state_dict=model)
        else:
    ...
    @staticmethod
    def create_model(model_type: str, model_dir: str, head: str, state_dict=None) -> nn.Module:
        """
